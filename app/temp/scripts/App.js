...
var Cart = function () {
  function Cart() {
    ...
    this.cartIcon = (0, _jquery2.default)(".cart");
    this.cartContent = (0, _jquery2.default)(".cart__detail");
    this.events();
  }
...
var Button = function () {
  function Button() {
    ...
    this.sizeSelect = (0, _jquery2.default)(".product-detail__sizing-select a");
    this.events();
  }
